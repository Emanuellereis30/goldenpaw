        ...
        <ScrollView style={styles.modalContent}>
          <View style={styles.modalForm}>
              ...
              {["cachorro", "gato", "ave", "peixe"].map((tipo) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        petForm.tipo === tipo ? theme.primary : theme.surface,
                      borderColor: theme.border,
                    },
                  ]}
                ...
                >
                  <Text
                    style={[
                      ...
                      { color: petForm.tipo === tipo ? "#000" : theme.text },
                    ]}
                  >
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setPetForm({ ...petForm, nomeDono: text })
              }
            />
            ...
            <View style={styles.row}>
              <View style={{ flex: 1 }}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setPetForm({ ...petForm, bairro: text })
                  }
                />
              </View>
              <View style={{ flex: 1, marginLeft: 10 }}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setPetForm({ ...petForm, cidade: text })
                  }
                />
              </View>
            </View>
