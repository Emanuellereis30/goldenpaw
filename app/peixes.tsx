...
const PRODUCTS: CategoryProduct[] = [
  ...
  { id: '21', nome: 'Bomba de Oxigênio para Aquário', preco: 'R$ 57,80', image: require('../assets/img/bombaoxigenio.png') },
  { id: '24', nome: 'Pedras Decorativas para Aquário', preco: 'R$ 20,90', image: require('../assets/img/pedrasaquario.png') },
];
